<template>
  <div class="bg-black">
    ...
    <section id="legal" class="container mx-auto">
      ...
      <div id="definition" class="container">
      ...
      <div id="service-disruption-terminate" class="container pb-8">
        <p class="text-4xl text-white">
      ...
      <div id="partners-third-party" class="container pb-8">
        <p class="text-4xl text-white">
      ...
      <div id="ownership" class="container pb-8">
        <p class="text-4xl text-white">
      ...
      <div id="misc" class="container pb-8">
        <p class="text-4xl text-white">
          5. Miscellaneous
        </p>
        <p class="text-white pb-8">
