<template>
  <div class="bg-black">
    ...
    <section id="legal" class="container mx-auto">
      ...
      <div id="definition" class="container pb-8">
        <p class="text-white">
      ...
      <div id="use-of-services" class="container pb-8">
        <p class="text-4xl text-white pb4">
          1. Policy Scope
        </p>
      ...
      <div id="info-collected" class="container pb-8">
      ...
      <div id="how-we-use-info" class="container pb-8">
        <p class="text-4xl text-white">
      ...
      <div id="share-info" class="container pb-8">
        <p class="text-4xl text-white">
      ...
      <div id="control-info" class="container pb-8">
        <p class="text-4xl text-white">
      ...
      <div id="do-not-track" class="container pb-8">
        <p class="text-4xl text-white">
          6. Do Not Track
        </p>
        <p class="text-white">
      ...
      <div id="gdpr" class="container pb-8">
        <p class="text-4xl text-white">
          7. GDPR
        </p>
        <p class="text-white">
      ...
      <div id="age-restrictions" class="container pb-8">
        <p class="text-4xl text-white">
          8. Age Restrictions
        </p>
        <p class="text-white">
      ...
      <div id="assignment" class="container pb-8">
        <p class="text-4xl text-white">
      ...
      <div id="contact-us" class="container pb-8">
        <p class="text-4xl text-white">
          11. Contact Us
        </p>
        <p class="text-white">
